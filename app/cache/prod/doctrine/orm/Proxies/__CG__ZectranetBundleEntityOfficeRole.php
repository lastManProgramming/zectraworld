 ...
 */
class OfficeRole extends \ZectranetBundle\Entity\OfficeRole implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZectranetBundle\\Entity\\OfficeRole' . "\0" . 'id', '' . "\0" . 'ZectranetBundle\\Entity\\OfficeRole' . "\0" . 'name', '' . "\0" . 'ZectranetBundle\\Entity\\OfficeRole' . "\0" . 'officeid', '' . "\0" . 'ZectranetBundle\\Entity\\OfficeRole' . "\0" . 'office');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OfficeRole $proxy) {
