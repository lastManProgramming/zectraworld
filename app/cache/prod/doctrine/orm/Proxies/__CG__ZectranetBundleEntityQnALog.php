 ...
 */
class QnALog extends \ZectranetBundle\Entity\QnALog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZectranetBundle\\Entity\\QnALog' . "\0" . 'id', '' . "\0" . 'ZectranetBundle\\Entity\\QnALog' . "\0" . 'message', '' . "\0" . 'ZectranetBundle\\Entity\\QnALog' . "\0" . 'projectID', '' . "\0" . 'ZectranetBundle\\Entity\\QnALog' . "\0" . 'project', '' . "\0" . 'ZectranetBundle\\Entity\\QnALog' . "\0" . 'date');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (QnALog $proxy) {
