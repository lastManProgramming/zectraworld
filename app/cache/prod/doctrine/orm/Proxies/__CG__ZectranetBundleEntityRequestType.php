 ...
 */
class RequestType extends \ZectranetBundle\Entity\RequestType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZectranetBundle\\Entity\\RequestType' . "\0" . 'id', '' . "\0" . 'ZectranetBundle\\Entity\\RequestType' . "\0" . 'label', '' . "\0" . 'ZectranetBundle\\Entity\\RequestType' . "\0" . 'color');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RequestType $proxy) {
