 ...
 */
class Document extends \ZectranetBundle\Entity\Document implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZectranetBundle\\Entity\\Document' . "\0" . 'id', '' . "\0" . 'ZectranetBundle\\Entity\\Document' . "\0" . 'userid', '' . "\0" . 'ZectranetBundle\\Entity\\Document' . "\0" . 'user', '' . "\0" . 'ZectranetBundle\\Entity\\Document' . "\0" . 'name', '' . "\0" . 'ZectranetBundle\\Entity\\Document' . "\0" . 'path', '' . "\0" . 'ZectranetBundle\\Entity\\Document' . "\0" . 'uploaded');
        }
