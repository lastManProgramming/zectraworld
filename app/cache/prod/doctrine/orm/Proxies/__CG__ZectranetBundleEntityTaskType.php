 ...
 */
class TaskType extends \ZectranetBundle\Entity\TaskType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZectranetBundle\\Entity\\TaskType' . "\0" . 'id', '' . "\0" . 'ZectranetBundle\\Entity\\TaskType' . "\0" . 'label', '' . "\0" . 'ZectranetBundle\\Entity\\TaskType' . "\0" . 'color', '' . "\0" . 'ZectranetBundle\\Entity\\TaskType' . "\0" . 'tasks');
        }
