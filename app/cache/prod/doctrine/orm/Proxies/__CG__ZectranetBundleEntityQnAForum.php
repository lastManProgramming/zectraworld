 ...
 */
class QnAForum extends \ZectranetBundle\Entity\QnAForum implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZectranetBundle\\Entity\\QnAForum' . "\0" . 'id', '' . "\0" . 'ZectranetBundle\\Entity\\QnAForum' . "\0" . 'name', '' . "\0" . 'ZectranetBundle\\Entity\\QnAForum' . "\0" . 'ownerID', '' . "\0" . 'ZectranetBundle\\Entity\\QnAForum' . "\0" . 'owner', '' . "\0" . 'ZectranetBundle\\Entity\\QnAForum' . "\0" . 'users', '' . "\0" . 'ZectranetBundle\\Entity\\QnAForum' . "\0" . 'officeID', '' . "\0" . 'ZectranetBundle\\Entity\\QnAForum' . "\0" . 'office', '' . "\0" . 'ZectranetBundle\\Entity\\QnAForum' . "\0" . 'threads', '' . "\0" . 'ZectranetBundle\\Entity\\QnAForum' . "\0" . 'shared', '' . "\0" . 'ZectranetBundle\\Entity\\QnAForum' . "\0" . 'created', '' . "\0" . 'ZectranetBundle\\Entity\\QnAForum' . "\0" . 'logs', '' . "\0" . 'ZectranetBundle\\Entity\\QnAForum' . "\0" . 'archived');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (QnAForum $proxy) {
