 ...
 */
class OfficeArchiveLog extends \ZectranetBundle\Entity\OfficeArchiveLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZectranetBundle\\Entity\\OfficeArchiveLog' . "\0" . 'id', '' . "\0" . 'ZectranetBundle\\Entity\\OfficeArchiveLog' . "\0" . 'message', '' . "\0" . 'ZectranetBundle\\Entity\\OfficeArchiveLog' . "\0" . 'officeID', '' . "\0" . 'ZectranetBundle\\Entity\\OfficeArchiveLog' . "\0" . 'office', '' . "\0" . 'ZectranetBundle\\Entity\\OfficeArchiveLog' . "\0" . 'date');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OfficeArchiveLog $proxy) {
