 ...
 */
class OfficePost extends \ZectranetBundle\Entity\OfficePost implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZectranetBundle\\Entity\\OfficePost' . "\0" . 'id', '' . "\0" . 'ZectranetBundle\\Entity\\OfficePost' . "\0" . 'message', '' . "\0" . 'ZectranetBundle\\Entity\\OfficePost' . "\0" . 'posted', '' . "\0" . 'ZectranetBundle\\Entity\\OfficePost' . "\0" . 'edited', '' . "\0" . 'ZectranetBundle\\Entity\\OfficePost' . "\0" . 'officeid', '' . "\0" . 'ZectranetBundle\\Entity\\OfficePost' . "\0" . 'office', '' . "\0" . 'ZectranetBundle\\Entity\\OfficePost' . "\0" . 'userid', '' . "\0" . 'ZectranetBundle\\Entity\\OfficePost' . "\0" . 'user');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OfficePost $proxy) {
