 ...
 */
class HFThread extends \ZectranetBundle\Entity\HFThread implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZectranetBundle\\Entity\\HFThread' . "\0" . 'id', '' . "\0" . 'ZectranetBundle\\Entity\\HFThread' . "\0" . 'userID', '' . "\0" . 'ZectranetBundle\\Entity\\HFThread' . "\0" . 'user', '' . "\0" . 'ZectranetBundle\\Entity\\HFThread' . "\0" . 'posts', '' . "\0" . 'ZectranetBundle\\Entity\\HFThread' . "\0" . 'sticky', '' . "\0" . 'ZectranetBundle\\Entity\\HFThread' . "\0" . 'date', '' . "\0" . 'ZectranetBundle\\Entity\\HFThread' . "\0" . 'subHeaderID', '' . "\0" . 'ZectranetBundle\\Entity\\HFThread' . "\0" . 'subHeader', '' . "\0" . 'ZectranetBundle\\Entity\\HFThread' . "\0" . 'title', '' . "\0" . 'ZectranetBundle\\Entity\\HFThread' . "\0" . 'message', '' . "\0" . 'ZectranetBundle\\Entity\\HFThread' . "\0" . 'keywords');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HFThread $proxy) {
    ...
    public function setSubHeaderID($subHeaderID)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSubHeaderID', array($subHeaderID));

        return parent::setSubHeaderID($subHeaderID);
    }
    ...
    public function getSubHeaderID()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSubHeaderID', array());

        return parent::getSubHeaderID();
    }
