 ...
 */
class ProjectPost extends \ZectranetBundle\Entity\ProjectPost implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZectranetBundle\\Entity\\ProjectPost' . "\0" . 'id', '' . "\0" . 'ZectranetBundle\\Entity\\ProjectPost' . "\0" . 'message', '' . "\0" . 'ZectranetBundle\\Entity\\ProjectPost' . "\0" . 'posted', '' . "\0" . 'ZectranetBundle\\Entity\\ProjectPost' . "\0" . 'edited', '' . "\0" . 'ZectranetBundle\\Entity\\ProjectPost' . "\0" . 'projectid', '' . "\0" . 'ZectranetBundle\\Entity\\ProjectPost' . "\0" . 'project', '' . "\0" . 'ZectranetBundle\\Entity\\ProjectPost' . "\0" . 'userid', '' . "\0" . 'ZectranetBundle\\Entity\\ProjectPost' . "\0" . 'user');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectPost $proxy) {
