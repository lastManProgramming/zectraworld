 ...
 */
class TaskStatus extends \ZectranetBundle\Entity\TaskStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZectranetBundle\\Entity\\TaskStatus' . "\0" . 'id', '' . "\0" . 'ZectranetBundle\\Entity\\TaskStatus' . "\0" . 'label', '' . "\0" . 'ZectranetBundle\\Entity\\TaskStatus' . "\0" . 'color', '' . "\0" . 'ZectranetBundle\\Entity\\TaskStatus' . "\0" . 'tasks');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaskStatus $proxy) {
