 ...
 */
class ProjectLog extends \ZectranetBundle\Entity\ProjectLog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZectranetBundle\\Entity\\ProjectLog' . "\0" . 'id', '' . "\0" . 'ZectranetBundle\\Entity\\ProjectLog' . "\0" . 'message', '' . "\0" . 'ZectranetBundle\\Entity\\ProjectLog' . "\0" . 'projectID', '' . "\0" . 'ZectranetBundle\\Entity\\ProjectLog' . "\0" . 'project', '' . "\0" . 'ZectranetBundle\\Entity\\ProjectLog' . "\0" . 'date');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProjectLog $proxy) {
