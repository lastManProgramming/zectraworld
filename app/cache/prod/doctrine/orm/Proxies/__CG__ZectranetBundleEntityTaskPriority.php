 ...
 */
class TaskPriority extends \ZectranetBundle\Entity\TaskPriority implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZectranetBundle\\Entity\\TaskPriority' . "\0" . 'id', '' . "\0" . 'ZectranetBundle\\Entity\\TaskPriority' . "\0" . 'label', '' . "\0" . 'ZectranetBundle\\Entity\\TaskPriority' . "\0" . 'color', '' . "\0" . 'ZectranetBundle\\Entity\\TaskPriority' . "\0" . 'tasks');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaskPriority $proxy) {
