 ...
 */
class ConversationMessage extends \ZectranetBundle\Entity\ConversationMessage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ZectranetBundle\\Entity\\ConversationMessage' . "\0" . 'id', '' . "\0" . 'ZectranetBundle\\Entity\\ConversationMessage' . "\0" . 'userID', '' . "\0" . 'ZectranetBundle\\Entity\\ConversationMessage' . "\0" . 'user', '' . "\0" . 'ZectranetBundle\\Entity\\ConversationMessage' . "\0" . 'conversationID', '' . "\0" . 'ZectranetBundle\\Entity\\ConversationMessage' . "\0" . 'conversation', '' . "\0" . 'ZectranetBundle\\Entity\\ConversationMessage' . "\0" . 'message', '' . "\0" . 'ZectranetBundle\\Entity\\ConversationMessage' . "\0" . 'posted', '' . "\0" . 'ZectranetBundle\\Entity\\ConversationMessage' . "\0" . 'edited');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ConversationMessage $proxy) {
    ...
    public function setConversation(\ZectranetBundle\Entity\Conversation $conversation = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setConversation', array($conversation));
    ...
    public function getConversation()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getConversation', array());
