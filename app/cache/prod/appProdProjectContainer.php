...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'zectranet.errorlogger' => 'getZectranet_ErrorloggerService',
            'zectranet.notifier' => 'getZectranet_NotifierService',
            'zectranet.officearchivelogger' => 'getZectranet_OfficearchiveloggerService',
            'zectranet.projectlogger' => 'getZectranet_ProjectloggerService',
            'zectranet.tasklogger' => 'getZectranet_TaskloggerService',
        );
        $this->aliases = array(
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'zectraworld.com.mysql', 'port' => 3306, 'dbname' => 'zectraworld_com', 'user' => 'zectraworld_com', 'password' => 'VUrUGMfc', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/ZectranetBundle/Entity'))), 'ZectranetBundle\\Entity');
        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ZectranetBundle' => 'ZectranetBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_148d73295d81b9f144f48ce3e43dd27ed4a4683f2be241b3dd33f86b40b94f60');
        return $instance;
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('ZectranetBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => false, 2 => 1))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($g, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.user_db')), 'secured_area', $a, $c), 2 => $i, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $h, 'secured_area', $j, $k, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5581f18a93d44', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $g, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $h, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $h, '/login', false), NULL, NULL, $a));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/ZectranetBundle/Resources/views'), 'Zectranet');
    ...
    protected function getZectranet_ErrorloggerService()
    {
        return $this->services['zectranet.errorlogger'] = new \ZectranetBundle\Services\ErrorLogger($this->get('security.token_storage'), $this->get('doctrine.orm.default_entity_manager'));
    }
    protected function getZectranet_NotifierService()
    {
        return $this->services['zectranet.notifier'] = new \ZectranetBundle\Services\Notifier($this->get('security.token_storage'), $this->get('doctrine.orm.default_entity_manager'), $this->get('router'), $this->get('swiftmailer.mailer.default'));
    }
    protected function getZectranet_OfficearchiveloggerService()
    {
        return $this->services['zectranet.officearchivelogger'] = new \ZectranetBundle\Services\OfficeArchiveLogger($this->get('security.token_storage'), $this->get('doctrine.orm.default_entity_manager'));
    }
    protected function getZectranet_ProjectloggerService()
    {
        return $this->services['zectranet.projectlogger'] = new \ZectranetBundle\Services\ProjectLogger($this->get('security.token_storage'), $this->get('doctrine.orm.default_entity_manager'));
    }
    protected function getZectranet_TaskloggerService()
    {
        return $this->services['zectranet.tasklogger'] = new \ZectranetBundle\Services\TaskLogger($this->get('security.token_storage'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.user_db'), new \Symfony\Component\Security\Core\User\UserChecker(), 'secured_area', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5581f18a93d44')), true);
    ...
    {
        return $this->services['security.user.provider.concrete.user_db'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'ZectranetBundle\\Entity\\User', NULL, NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ZectranetBundle' => 'ZectranetBundle\\ZectranetBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdProjectContainer',
            'database_driver' => 'pdo_mysql',
            'database_host' => 'zectraworld.com.mysql',
            'database_port' => 3306,
            'database_name' => 'zectraworld_com',
            'database_user' => 'zectraworld_com',
            'database_password' => 'VUrUGMfc',
